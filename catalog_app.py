...
def gconnect():
    ...
    if requests.args.get('state') != login_session['state']:
        response = make_respose(json.dumps('Invalid state parameter.') 401)
    ...
    try:
        ...
        print "FlowExchangeError -> check client_secrets"
    ...
    # Add necessary fields to the login session
